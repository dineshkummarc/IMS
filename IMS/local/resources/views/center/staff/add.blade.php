			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						xmlhttp.open("GET","../../chkUsername.php?id="+id,true);
						xmlhttp.send();
						}
						</script>
						...
						<form action="{!! Asset('center/staff/add') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="joining_date" id="datepicker" class="form-control"  value="{{old('joining_date')}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="user_name" class="form-control"  value="{{old('username')}}" onchange="chkUsername(this.value)">
						</div>
						</div>
