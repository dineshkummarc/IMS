			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<h5 class="over-title"><i class="fa fa-edit"></i> Edit Fee Entry </h5>
						<form action="{!! Asset('center/fee/edit/'.$res->id.'/'.$chk->id) !!}" method="post" class="form-login">
						...
						<label> Amount</label>
						<div class="form-group">
						<input type="text"  name="amount" id="amount" class="form-control" required value="{{$res->amount}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="naration" id="naration" class="form-control" value="{{$res->naration}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker3" class="form-control" required value="{{$res->date_added}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="due_date" id="datepicker22" class="form-control" value="{{$res->due_date}}">
						</div>
						</div>
