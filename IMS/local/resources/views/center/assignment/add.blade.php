					...
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							...
							<ul class="pull-right breadcrumb">
								...
								<li>
									<i class="fa fa-graduation-cap"></i> Assignment
								</li>
							</ul>
						</div>					
						...
						<form action="{!! Asset('center/app/assignment/add') !!}" method="post" class="form-login" enctype="multipart/form-data">
						...
						<label> Course </label>
						<div class="form-group">
						<select name="course_id" class="form-control" onchange="getBatch(this.value)" required>
						...
						<div class="form-group">
						<label> Upload File (<i>Upload files like any text file, any image or any docx, pdf file</i>) <span class="symbol required"></span></label>
						<div class="form-group">
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control"  value="{{date('Y-m-d')}}" required>
						</div>
						</div>
