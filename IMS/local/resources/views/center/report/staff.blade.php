				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-users"></i> Staff Reporting</h4>
							...
							<ul class="pull-right breadcrumb">
								...
								<li>
									<i class="fa fa-graduation-cap"></i> Staff Reporting
								</li>
							</ul>
						</div>					
						...
						<h5 class="over-title"><i class="fa fa-file"></i> Get all staff report with attendance</h5>
						<form action="{!! Asset('center/staffReport') !!}" method="post" class="form-login" target="_blank">
						...
						<label> Staff </label>
						<div class="form-group">
						<select name="staff" class="form-control" onchange="getBatch(this.value)">
