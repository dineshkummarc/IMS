			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/Todo/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<label> Date </label>
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker" class="form-control"  value="{{$res->date_added}}">
						</div>
						</div>
						...
						<option value="1" <?php if($res->status == 1){ echo "selected"; } ?>>Completed</option>
