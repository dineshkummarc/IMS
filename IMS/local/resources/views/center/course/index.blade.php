				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-graduation-cap"></i> Manage Course 
							<?php if(Perm::check("Add Courses")){ ?>
							<a href="{{Asset('center/course/add')}}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a><?php } ?></h4>
						...
						<td width="10%">{{$row->course_time}}</td>
						<td width="10%">Rs.{{$row->fee}}</td>
						<td width="20%">{!!$batchName!!}</td>
						...
						<a href="{{Asset('center/course/edit/'.$row->id)}}" class="btn btn-success"><i class="fa fa-edit"></i> </a>
						<?php } ?>
						
						<?php if(Perm::check("Delete Courses")){ ?>
						<a href="{{Asset('center/course/delete/'.$row->id)}}" class="btn btn-danger" onclick="return confirm('Are You Sure ?')"><i class="fa fa-trash"></i></a>					
						<?php } ?>
