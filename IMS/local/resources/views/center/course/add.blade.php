			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/course/add') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="course_time" id="course_time" class="form-control" required  value="{{old('course_time')}}">
						</div>
						</div>
