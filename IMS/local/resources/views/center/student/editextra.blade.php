			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/student/extraCharge/'.$fee->id.'/'.$id) !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="narration" id="name" class="form-control" required value="{{$fee->naration}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="amount" id="last_name" class="form-control" required value="{{$fee->amount}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control"  value="{{$fee->date_added}}">
						</div>
						</div>
