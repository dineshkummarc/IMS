				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-cog"></i> Settings</h4>
						...
						<h5 class="over-title"><i class="fa fa-cog"></i> Admin Settings</h5>
						<form action="{!! Asset('center/setting') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text" placeholder="Username" name="user_name" id="email" class="form-control" value="{{$array->user_name}}">
						</div>
						</div>
						<?php if(Auth::user()->id == env("admin_id")){ ?>
						<div class="form-group">
						<label> Institute Name <span class="symbol required"></span> </label>
						<div class="form-group">
						<input type="text" name="center_name" id="center_name" class="form-control" required value="{{$array->center_name}}">
						</div>
						</div>
						<?php } ?>
						
						<div class="form-group">
						<label> Person Name <span class="symbol required"></span> </label>
						<div class="form-group">
						<input type="text" name="person_name" id="person_name" class="form-control" required value="{{$array->person_name}}">
						</div>
						</div>
						
						<div class="form-group">
						<label> Email (<i>All alerts and notification will come on this email</i>)<span class="symbol required"></span> </label>
						<div class="form-group">
						<input type="email" name="email" id="email" class="form-control" value="{{$array->email}}">
						</div>
						</div>
						...
						<div class="form-group">
						<textarea name="address" class="form-control" required>{{$array->address}}</textarea>
						</div>
						</div>
						<?php } ?>
						...
						<div class="form-group">
						<input type="password" placeholder="Enter new password if you want to change password" name="password" id="password" class="form-control">
						</div>
						</div>
