				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-users"></i> Manage Batch 
							<?php if(Perm::check("Add Batch")){ ?>
							<a href="{{Asset('center/batch/add')}}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a>
							<?php } ?>
							</h4>
						...
						<?php if(Perm::check("Edit Batch")){ ?>
						<a href="{{Asset('center/batch/edit/'.$row->id)}}" class="btn btn-success"><i class="fa fa-edit"></i> </a>
						<?php } ?>
						
						<?php if(Perm::check("Delete Batch")){ ?>
						<a href="{{Asset('center/batch/delete/'.$row->id)}}" class="btn btn-danger" onclick="return confirm('Are You Sure ?')"><i class="fa fa-trash"></i></a>					
						<?php } ?>
