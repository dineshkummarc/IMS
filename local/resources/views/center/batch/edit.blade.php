			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/batch/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<label> Batch Name <span class="symbol required"></span> </label>
						<div class="form-group">
