			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/expense/add') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="number"  name="amount" id="phone" class="form-control" required  value="{{old('amount')}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control"  value="{{old('date_added')}}" required>
						</div>
						</div>
