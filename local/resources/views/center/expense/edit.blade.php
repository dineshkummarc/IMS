					...
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							...
							<ul class="pull-right breadcrumb">
								...
								<li>
									<i class="fa fa-graduation-cap"></i> Expense
								</li>
							</ul>
						</div>					
						...
						<form action="{!! Asset('center/expense/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="narration" id="name" class="form-control" required value="{{$res->narration}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="number"  name="amount" id="phone" class="form-control" required  value="{{$res->amount}}">
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control"  value="{{$res->date_added}}" required>
						</div>
						</div>
