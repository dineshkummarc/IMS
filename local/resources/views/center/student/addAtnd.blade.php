			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						xmlhttp.open("GET","../../Atndbatch.php?id="+id,true);
						xmlhttp.send();
						}
						</script>
						...
						<form action="{!! Asset('center/studentAttendance/get') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<select name="course" class="form-control" required onchange="getBatch(this.value)">
