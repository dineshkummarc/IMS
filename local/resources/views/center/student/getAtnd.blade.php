				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							...
							{							
							?>
							Course: {{$course->name}}, Batch: {{$batch}}
							<?php } ?>
						...
						$student    = DB::table("student")->where('id',$row->student_id)->first();
						...
						<a href="{{Asset('center/studentAttendance/delete/'.$row->id)}}" data-placement="top" data-toggle="tooltip" class="btn btn-danger" onclick="return confirm('Are You Sure ?')" data-original-title="Delete"><i class="fa fa-trash"></i> Delete</a>					
