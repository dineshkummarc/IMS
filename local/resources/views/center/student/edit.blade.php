			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/student/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<label> Date Of Birth <span class="symbol required"></span></label>
						<div class="form-group">
						<input type="text"  name="dob" id="datepicker" class="form-control"  value="{{$res->dob}}">
						</div>
						</div>
						...
						<a href="{{Asset('center/student/courseEdit/'.$res->id)}}" style="font-size:16px;float:right;">Want To Change Course ?</a><br>
						<div class="form-group">
						<label> Course </label>
						<div class="form-group">
						<select name="course_id" class="form-control" required onchange="getFee(this.value)" disabled="disabled">
						...
						<label>Roll No</label>
						<div class="form-group">
						<input type="text"  name="roll_no" id="roll_no" class="form-control"  value="{{$courseRes->roll_no}}">
						</div>
						</div>	
						...
						<div class="form-group">
						<textarea name="remark" class="form-control" >{{$courseRes->remark}}</textarea>
						</div>
						</div>
