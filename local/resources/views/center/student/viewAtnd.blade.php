				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							...
							<?php if(Perm::check("Add Student Attendance")){ ?>
							<a href="{{Asset('center/studentAttendance/add')}}" class="btn btn-success"><i class="fa fa-plus"></i> Add New</a><?php } ?></h4>
						...
						xmlhttp.open("GET","../ViewAtndbatch.php?id="+id,true);
						xmlhttp.send();
						}
						</script>
						...
						xmlhttp.open("GET","../getStudent.php?batch="+id+"&course="+course,true);
						xmlhttp.send();
						}
						</script>
						...
						<form action="{!! Asset('center/studentAttendance/view') !!}" method="get" class="form-login">
						...
						<label>Select Course  <span class="symbol required"></span> </label>
						<div class="form-group">
						<select name="course" class="form-control" required onchange="getBatch(this.value)" id="course">
						...
						<div class="form-group">
						<select name="batch" class="form-control" id="batch" onchange="getStudent(this.value)" required>
						...
						<div class="form-group">
						<input type="text" name="from" class="form-control" id="datepicker2" required>
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text" name="to" class="form-control" id="datepicker3" required>
						</div>
						</div>
						
						<div class="form-group">						
						<div class="form-group">
						<button type="submit" class="btn btn-wide btn-success">View Attendance</button>
						</div>
						</div>						
						</fieldset>												
						</form>
