...
<head>
		...
		<script src="{{Asset('ck/samples/js/sample.js')}}"></script>
		<link rel="stylesheet" href="{{Asset('ck/samples/css/samples.css')}}">
		<link rel="stylesheet" href="{{Asset('ck/samples/toolbarconfigurator/lib/codemirror/neo.css')}}">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-cog"></i> App Settings</h4>
							
							<ul class="pull-right breadcrumb">
								<li>
									<a href="{{Asset('home')}}"><i class="fa fa-home margin-right-5 text-large text-dark"></i>Home</a>
								</li>
								<li>
						...
						<h5 class="over-title"><i class="fa fa-cog"></i> App Settings</h5>
						<form action="{!! Asset('center/Appsetting') !!}" method="post" class="form-login" enctype="multipart/form-data">
						...
						<label> Banner (<i>it should be 600 x 200 for batter view</i>)<span class="symbol required"></span> </label>
						<div class="form-group">
						...
						<img src="{{Asset('upload/AppData/'.$res->img)}}" style="height:300px" class="form-control">
						<a href="{{Asset('center/Appsetting/imgRemove')}}" onclick="return confirm('Are you sure ?')" style="color:red"><i class="fa fa-times"></i> Remove This Image</a><br>
						<?php
						}
						...
						<div class="form-group">
						<label> Lastest News  <span class="symbol required"></span> </label>
						<div class="form-group">
						<textarea class="ckeditor form-control"  id="editor" name="description">
						<?php if($res){  echo $res->description; } ?>
