			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/staff/attendance/add') !!}" method="post" class="form-login">
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control" required value="{{date('Y-m-d')}}">
						</div>
						</div>
						</fieldset>
						<fieldset>
						<legend>
						Uncheck the staff name if its not present
						</legend>
						<?php
						$i=0;
						...
						<input type="checkbox" id="checkbox_{{$i}}" value="1" name="chk_{{$staff->id}}" checked>
						<label for="checkbox_{{$i}}">{{$staff->name}} </label>
						</div>
