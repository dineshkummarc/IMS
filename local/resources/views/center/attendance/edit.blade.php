			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<form action="{!! Asset('center/staff/attendance/edit/'.$res->id) !!}" method="post" class="form-login">
						...
						<label>Staff Name  <span class="symbol required"></span> </label>
						<div class="form-group">
						<input type="text"  name="staff" id="" class="form-control" required value="{{$staff->name}}" disabled>
						</div>
						</div>
						...
						<div class="form-group">
						<input type="text"  name="date_added" id="datepicker2" class="form-control" required value="{{$res->date_added}}">
						</div>
						</div>

						<div class="form-group">
						<label>Attendance  <span class="symbol required"></span> </label>
						<div class="form-group">
						<select name="type" class="form-control">
						<option value="0" <?php if($res->type == 0){ echo "selected"; } ?>>Present</option>
						<option value="1" <?php if($res->type == 1){ echo "selected"; } ?>>Absent</option>
						</select>
						</div>
						</div>
