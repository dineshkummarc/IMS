				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-edit"></i> Manage Assignment <a href="{{Asset('center/app/assignment/add')}}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a></h4>
						...
						if($row->batch == ""){ $batch = "All"; } else { $batch = $row->batch; }
						...
						<td width="10%"><a href="{{Asset('upload/assignment/'.$row->file)}}" target="_blank">View File</a></td>						
						<td width="10%">{{$dd}}</td>
						...
						<a href="{{Asset('center/app/assignment/delete/'.$row->id)}}" class="btn btn-danger" onclick="return confirm('Are You Sure ?')"><i class="fa fa-trash"></i> Delete</a>					
