				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-users"></i> Passout Students <a href="{{Asset('center/student/add')}}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add New</a> 
						...
						<a href="{{Asset('center/result/edit/'.$row->id.'#docs')}}" data-placement="top" data-toggle="tooltip" class="btn btn-warning" data-original-title="Upload Document"><i class="fa fa-link"></i></a>
						
						
						<a href="{{Asset('center/result/edit/'.$row->id)}}" data-placement="top" data-toggle="tooltip" class="btn btn-success" data-original-title="Edit Student Detail"><i class="fa fa-edit"></i> </a>
						
						<?php 
						$docs = DB::table("student_docs")->where('student_id',$row->id)->count();
						if($docs > 0){
						?>
						<a href="{{Asset('center/result/edit/'.$row->id.'#docs')}}" data-placement="top" data-toggle="tooltip" class="btn btn-primary" data-original-title="View Documents"><i class="fa fa-file"></i> </a>
						<?php } ?>
						</td>
