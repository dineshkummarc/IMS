				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="breadcrumb-wrapper">
							<h4 class="mainTitle no-margin"><i class="fa fa-credit-card-alt"></i> Fee Reporting</h4>
							...
							<ul class="pull-right breadcrumb">
								...
								<li>
									<i class="fa fa-graduation-cap"></i> Fee Reporting
								</li>
							</ul>
						</div>					
						...
						<h5 class="over-title"><i class="fa fa-file"></i> Get deposited fee report using bellow details</h5>
						<form action="{!! Asset('center/feeReport') !!}" method="post" class="form-login" target="_blank">
